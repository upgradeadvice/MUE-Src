...
$(package)_qtwebengine_sha256_hash=b6ac5f6e140ce092bffd5913497043fbbcb9aa87d3aa06afaffe82b0172ef747
...
define $(package)_extract_cmds
  ...
  tar --strip-components=1 -xf $($(package)_source_dir)/$($(package)_qttools_file_name) -C qttools && \
	mkdir qtwebengine && \
	tar --strip-components=1 -xf $($(package)_source_dir)/$($(package)_qtwebengine_file_name) -C qtwebengine
endef
...
define $(package)_stage_cmds
  ...
  $(MAKE) -C qttranslations INSTALL_ROOT=$($(package)_staging_dir) install_subtargets && \
	$(MAKE) -C qtwebengine INSTALL_ROOT=$($(package)_staging_dir) install_subtargets && \

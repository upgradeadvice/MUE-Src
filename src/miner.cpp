...
void static MonetaryUnitMiner(CWallet *pwallet)
{
...
void GenerateMonetaryUnits(bool fGenerate, CWallet* pwallet, int nThreads)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&MonetaryUnitMiner, pwallet));
}

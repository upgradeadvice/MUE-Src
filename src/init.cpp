...
// Copyright (c) 2013 Monetaryunit developers
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/monetaryunit.conf are parsed in qt/bitcoin.cpp's main()
        ...
        {
            // First part of help message is specific to monetaryunitd / RPC client
            std::string strUsage = _("Monetaryunit version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  monetaryunitd [options]                     " + "\n" +
                  "  monetaryunitd [options] <command> [params]  " + _("Send command to -server or monetaryunitd") + "\n" +
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: monetaryunit.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: monetaryunitd.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Monetaryunit Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Monetaryunit is probably already running."), strDataDir.c_str()));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("Monetaryunit version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());
    ...
    if (nLoadWalletRet != DB_LOAD_OK)
    {
        ...
        else if (nLoadWalletRet == DB_NONCRITICAL_ERROR)
        {
            ...
            strErrors << _("Error loading wallet.dat: Wallet requires newer version of Monetaryunit") << "\n";
        else if (nLoadWalletRet == DB_NEED_REWRITE)
        {
            strErrors << _("Wallet needed to be rewritten: restart Monetaryunit to complete") << "\n";

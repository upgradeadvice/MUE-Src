// Copyright (c) 2012-2013 The MonetaryUnit Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.monetaryunit.org", "www.monetaryunit.org", -1));
    BOOST_CHECK(TestSplitHost("[www.monetaryunit.org]", "www.monetaryunit.org", -1));
    BOOST_CHECK(TestSplitHost("www.monetaryunit.org:80", "www.monetaryunit.org", 80));
    BOOST_CHECK(TestSplitHost("[www.monetaryunit.org]:80", "www.monetaryunit.org", 80));

...
bool IsCanonicalSignature(const valtype &vchSig, unsigned int flags) {
    ...
    // See https://monetaryunittalk.org/index.php?topic=8392.msg127623#msg127623
...
public:
    ...
    void Serialize(S &s, int nType, int nVersion) const {
        ...
        if(txTo.nVersion >= CTransaction::TXCOMMENT_VERSION) {
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (mTemplates.empty())
    {
        ...
        // MonetaryUnit address tx, sender provides hash of pubkey, receiver provides signature and pubkey

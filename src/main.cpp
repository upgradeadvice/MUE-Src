...
// Copyright (c) 2013 The Monetaryunit developers
...
uint256 hashGenesisBlock("0x0000070e6b650e7a6f20e015031b74c1f7e2b25ed4e419d8825ab9cc7eccfa92");
static const unsigned int timeGenesisBlock = 1404668200;
...
bool CTransaction::IsStandard() const
{
    ...
    unsigned int sz = this->GetSerializeSize(SER_NETWORK, CTransaction::TXCOMMENT_VERSION);
...
static const int64 nGenesisBlockRewardCoin = 0 * COIN;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa2cc3c1d8ab6e50e80464693199eefdd172d45c4129998394e636e47b5621364");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 112;
        block.nTime    = timeGenesisBlock + 5;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xa2cc3c1d8ab6e50e80464693199eefdd172d45c4129998394e636e47b5621364"));
...
unsigned char pchMessageStart[4] = { 0x04, 0x05, 0x05, 0x04 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MonetaryunitMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("MonetaryunitMiner started\n");
    ...
    try { loop {
        ...
        printf("Running MonetaryunitMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("MonetaryunitMiner terminated\n");
        throw;
    }
}

...
QString BitcoinUnits::description(int unit)
{
    ...
    case mMUE: return QString("Milli-MonetaryUnits (1 / 1" THIN_SP_UTF8 "000)");
    //case uMUE: return QString("Micro-MonetaryUnits (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}

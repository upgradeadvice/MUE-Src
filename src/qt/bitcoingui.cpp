...
{
    resize(1100, 650);
    setWindowTitle(tr("Monetaryunit") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Monetaryunit address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Monetaryunit"), this);
    aboutAction->setToolTip(tr("Show information about Monetaryunit"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Monetaryunit"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Monetaryunit client") + QString(" ") + tr("[testnet]"));
    ...
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          ...
          "Do you want to pay the fee?").arg(
                BitcoinUnits::formatWithUnit(BitcoinUnits::QRK, nFeeRequired));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Monetaryunit address or malformed URI parameters."));
    }
...
//    file.setFileName("themes"+QString(QDir::separator())+ name + QString(QDir::separator())+ name + ".qss");
    ...
    setMinimumSize(1000,750);  // You can remove this line just give good idea of theme at this resolution - Yash

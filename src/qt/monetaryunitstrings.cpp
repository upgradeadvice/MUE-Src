...
QT_TRANSLATE_NOOP("monetaryunit-core", ""
"Unable to bind to %s on this computer. MonetaryUnit Core is probably already "
"running."),
QT_TRANSLATE_NOOP("monetaryunit-core", ""
...
"your clock is wrong MonetaryUnit will not work properly."),
QT_TRANSLATE_NOOP("monetaryunit-core", ""
...
QT_TRANSLATE_NOOP("monetaryunit-core", "(default: wallet.dat)"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Allow JSON-RPC connections from specified IP address"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Attempt to recover private keys from a corrupt wallet.dat"),
QT_TRANSLATE_NOOP("monetaryunit-core", "MonetaryUnit Core Daemon"),
QT_TRANSLATE_NOOP("monetaryunit-core", "MonetaryUnit Core RPC client version"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Clear list of wallet transactions (diagnostic tool; implies -rescan)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Connect only to the specified node(s)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Connect through SOCKS proxy"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Connect to JSON-RPC on <port> (default: 8332 or testnet: 18332)"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Disable safemode, override a real safe mode event (default: 0)"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Error loading wallet.dat: Wallet requires newer version of MonetaryUnit"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Error: system error: "),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to read block info"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to read block"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to sync block index"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to write block index"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to write block info"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to write block"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to write file info"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to write to coin database"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to write transaction index"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Failed to write undo data"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Fee per kB to add to transactions you send"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Fees smaller than this are considered zero fee (for relaying) (default:"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Find peers using DNS lookup (default: 1 unless -connect)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Force safe mode (default: 0)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Generate coins (default: 0)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Get help for a command"),
QT_TRANSLATE_NOOP("monetaryunit-core", "How many blocks to check at startup (default: 288, 0 = all)"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Invalid -proxy address: '%s'"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Limit size of signature cache to <n> entries (default: 50000)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "List commands"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Listen for connections on <port> (default: 8333 or testnet: 18333)"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Log transaction priority and fee per kB when mining blocks (default: 0)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Maintain a full transaction index (default: 0)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Maintain at most <n> connections to peers (default: 125)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: 5000)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: 1000)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("monetaryunit-core", "Only accept block chain matching built-in checkpoints (default: 1)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Only connect to nodes in network <net> (IPv4, IPv6 or Tor)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Options:"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Prepend debug output with timestamp (default: 1)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Print block on startup, if found in block index"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Print block tree on startup (default: 0)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "RPC SSL options: (see the MonetaryUnit Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "RPC client options:"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Run a thread to flush wallet periodically (default: 1)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Run in the background as a daemon and accept commands"),
QT_TRANSLATE_NOOP("monetaryunit-core", "SSL options: (see the MonetaryUnit Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Select SOCKS version for -proxy (4 or 5, default: 5)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Send command to MonetaryUnit Core"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Send commands to node running on <ip> (default: 127.0.0.1)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Server certificate file (default: server.cert)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Server private key (default: server.pem)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Set database cache size in megabytes (%d to %d, default: %d)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Set key pool size to <n> (default: 100)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Set minimum block size in bytes (default: 0)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Set the number of threads to service RPC calls (default: 4)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Sets the DB_PRIVATE flag in the wallet db environment (default: 1)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Show all debugging options (usage: --help -help-debug)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Show benchmark information (default: 0)"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Specify configuration file (default: monetaryunit.conf)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Specify connection timeout in milliseconds (default: 5000)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Specify data directory"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Specify pid file (default: monetaryunitd.pid)"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Spend unconfirmed change when sending transactions (default: 1)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Start MonetaryUnit Core Daemon"),
QT_TRANSLATE_NOOP("monetaryunit-core", "System error: "),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Threshold for disconnecting misbehaving peers (default: 100)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "To use the %s option"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Unable to bind to %s on this computer (bind returned error %d, %s)"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Unknown -socks proxy version requested: %i"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Usage (deprecated, use monetaryunit-cli):"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Usage:"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Use OpenSSL (https) for JSON-RPC connections"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Use UPnP to map the listening port (default: 0)"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "Wait for RPC server to start"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Wallet needed to be rewritten: restart MonetaryUnit to complete"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Wallet options:"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Warning"),
QT_TRANSLATE_NOOP("monetaryunit-core", "Warning: Deprecated argument -debugnet ignored, use -debug=net"),
...
QT_TRANSLATE_NOOP("monetaryunit-core", "version"),

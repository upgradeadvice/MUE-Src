...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click monetaryunit: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start monetaryunit: click-to-pay handler");
    else
...
{
    // clicking on monetaryunit: URLs creates FileOpen events on the Mac:

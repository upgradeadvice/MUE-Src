...
<context>
    ...
    <message>
        ...
        <translation>用護靈模���在背後執行並接受指令</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "MonetaryUnit Alert" admin@foo.com
        ...
        <translation>要使用 monetaryunitd, 或是對 monetaryunit-qt 指定 -server 選項，你必須要在以下設定檔中設定 RPC 密碼(選項: rpcpassword):
%s
建議你使用以下隨機產生的密碼:
rpcuser=bitcoinrpc
rpcpassword=%s
...
比如說設定: alertnotify=echo %%s | mail -s "MonetaryUnit Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>在白名單中的節點不會因為偵測到阻斷服務攻擊而被停用。來自這些節點的交易也一定會被轉發，即使說交易本來就在記憶池裡了也一樣。適���於���是閘道伺���器。</translation>
    </message>
    <message>

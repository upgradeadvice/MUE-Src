...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"To use monetaryunitd, or the -server option to monetaryunit-qt, you must set an "
...
QT_TRANSLATE_NOOP("bitcoin-core", "Copyright (C) 2009-%i The MonetaryUnit Core Developers"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of MonetaryUnit Core"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. MonetaryUnit Core is shutting down."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "RPC SSL options: (see the MonetaryUnit Wiki for SSL setup instructions)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart MonetaryUnit Core to complete"),

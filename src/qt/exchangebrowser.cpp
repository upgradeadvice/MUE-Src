...
//Coinbase API
const QString apiCoinbasePrice = "http://www.bitstamp.net/api/ticker/";

//Bittrex API
const QString apiBittrexMarketSummary = "http://bittrex.com/api/v1.1/public/getmarketsummaries";
const QString apiBittrexTrades = "http://bittrex.com/api/v1.1/public/getmarkethistory?market=BTC-MUE&count=100";
const QString apiBittrexOrders = "http://bittrex.com/api/v1.1/public/getorderbook?market=BTC-MUE&type=both&depth=50";
...
void ExchangeBrowser::on_btnConvertmue_clicked()
{
    double mueQty = ui->txtConvertMueQty->text().toDouble();
    double totalBtc = _bittrexMarketSummary->getLastCurrent(double()) * mueQty;
    double totalUsd = totalBtc * _dBtcPriceCurrent;

    ui->lblConvertMueResults->setText("$" + QString::number(totalUsd, 'f', 2) +
...
{
    QDesktopServices::openUrl(QUrl("https://www.bittrex.com/Market/Index?MarketName=BTC-MUE"));
}
void ExchangeBrowser::openBleutrade()
{
    QDesktopServices::openUrl(QUrl("https://bleutrade.com/exchange/MUE/BTC"));
}
// void ExchangeBrowser::openPoloniex()
// {
//     QDesktopServices::openUrl(QUrl("https://poloniex.com/exchange/btc_MUE"));
// }
...
void ExchangeBrowser::getRequest(const QString &urlString)
{
    QUrl url (urlString);
...
void ExchangeBrowser::parseNetworkResponse(QNetworkReply* response)
{
...
/*************************************************************************************
 * Method: ExchangeBrowser::coinbasePrice
 ...
 *************************************************************************************/
void ExchangeBrowser::coinbasePrice(QNetworkReply* response)
{
    ...
    _dBtcPriceCurrent =  QString::fromStdString(getPairValue(jsonObject, "last").get_str()).toDouble();
...
/*************************************************************************************
 * Method: ExchangeBrowser::bittrexMarketSummary
 * Parameter(s): QNetworkReply* response
 *
 ...
 * }
 *************************************************************************************/
void ExchangeBrowser::bittrexMarketSummary(QNetworkReply* response)
{
    QString apiResponse = response->readAll();
    ...
    for(int i = 0; i < qslApiResponse.count(); i++){
        ...
        if(read_string(qslApiResponse[i].toStdString(), jsonResponse)) {
            ...
            if (getPairValue(jsonObject, "MarketName").get_str() == "BTC-MUE") {
                try {
...
/*************************************************************************************
 * Method: ExchangeBrowser::bittrexTrades
 * Parameter(s): QNetworkReply* response
 *
 ...
 * }
 *************************************************************************************/
void ExchangeBrowser::bittrexTrades(QNetworkReply* response)
{
    int z = 0;
...
/*************************************************************************************
 * Method: ExchangeBrowser::bittrexOrders
 * Parameter(s): QNetworkReply* response
 *
 ...
 * }
 ************************************************************************************/
void ExchangeBrowser::bittrexOrders(QNetworkReply* response)
{
    int z = 0;
    double high = 0;
    double low = 100000;
...
const mValue& ExchangeBrowser::getPairValue(const mObject& obj, const std::string& name)
{
...
void ExchangeBrowser::updateLabel(QLabel* qLabel, double d1, double d2, QString prefix, int decimalPlaces)
{
    qLabel->setText("");
...
void ExchangeBrowser::updateLabel(QLabel* qLabel, double d1, double d2, QString prefix, QString suffix, int decimalPlaces)
{
    qLabel->setText("");
...
void ExchangeBrowser::setModel(ClientModel *model)
{
    this->model = model;
}

...
#include "monetaryunit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMonetaryUnitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + MonetaryUnitUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMonetaryUnitURI(info));
}

 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called MonetaryUnit (http://www.monetaryunit.org/),

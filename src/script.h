...
#ifndef H_MONETARYUNIT_SCRIPT
#define H_MONETARYUNIT_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CMonetaryUnitAddress
 */
...
public:
    ...
    // Pre-version-0.6, MonetaryUnit always counted CHECKMULTISIGs

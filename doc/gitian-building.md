...
*Setup instructions for a gitian build of MonetaryUnit using a Debian VM or physical system.*
...
- [Building MonetaryUnit](#building-monetaryunit)
...
In [doc/release-process.md](release-process.md) in the monetaryunit repository under 'Fetch and build inputs'.
...
Building MonetaryUnit
----------------

To build MonetaryUnit (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the monetaryunit repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/monetaryunit/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/monetaryunit/monetaryunit
...
For example:
```bash
URL=https://github.com/laanwj/monetaryunit.git
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/monetaryunit-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/monetaryunit-build.assert
```
...
[monetaryunit/gitian.sigs](https://github.com/monetaryunit/gitian.sigs/) repository, or

MonetaryUnit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/monetaryunit/files/MonetaryUnit/monetaryunit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the MonetaryUnit
...
New/changed settings (command-line or monetaryunit.conf file)
--------------------------------------------------------

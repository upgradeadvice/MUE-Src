MonetaryUnit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/monetaryunit/files/MonetaryUnit/monetaryunit-0.5.4/
...
http://gitorious.org/monetaryunit/monetaryunitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix MonetaryUnit-Qt notifications under Growl 1.3.
Increase required age of MonetaryUnit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMonetaryUnit properly when installing MonetaryUnit-Qt over it. (Windows)

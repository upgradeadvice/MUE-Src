The following is a list of assets used in the monetaryunit source and their proper attribution.
...
* License: MIT
* Site: [https://monetaryunittalk.org/index.php?topic=15276.0](https://monetaryunittalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original monetaryunit logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/monetaryunit.icns, src/qt/res/src/monetaryunit.svg,
	src/qt/res/src/monetaryunit.ico, src/qt/res/src/monetaryunit.png,
	src/qt/res/src/monetaryunit_testnet.png, docs/monetaryunit_logo_doxygen.png,

...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars MONETARYUNITD and MONETARYUNITCLI may be used to specify the exact binaries used"
        exit 1
fi

set -f

MONETARYUNITD=${MONETARYUNITD:-${1}/monetaryunitd}
CLI=${MONETARYUNITCLI:-${1}/monetaryunit-cli}

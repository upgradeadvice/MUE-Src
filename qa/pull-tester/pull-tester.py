...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old MonetaryUnitPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/MonetaryUnitdComparisonTool_jar/MonetaryUnitdComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/monetaryunit/monetaryunit.git")
...
environ_default("BUILD_PATH", "/mnt/monetaryunit")
...
environ_default("GITHUB_REPO", "monetaryunit/monetaryunit")
